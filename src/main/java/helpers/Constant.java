...
public class Constant {
    ...
    public static final String USERNAME = "lookinss@gmail.com";
    public static final String PASSWORD = "12345678";
    public static final long DEFAULT_TIME_WAIT = 5;
    ...
    public static final int EXPIRED_DAYS_NUMBER = 3;
    public static final int DAYS_FROM_CURRENT_DATE = 6;
}
